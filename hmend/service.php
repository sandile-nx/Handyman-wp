...
<!-- Mirrored from htmldemo.net/hmend/hmend/service.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Apr 2023 09:40:27 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="header-rights">
                            <a href="appointment-tool.php"><i class="zmdi zmdi-calendar"></i> make appointment</a></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container md-container">
                <div class="row">
                    <div class="col-lg-2 col-md-4">
                        <div class="logo">
                            <a href="index-4.php"><img src="assets/img/logo/1.png" alt="" /></a>
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-8">
                        <div class="main-menu">
                            <nav>
                                <ul>
                                    <li class="active"><a href="index-4.php">home</a>
                                        <ul class="sub-menu">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="our-services-wrapper text-center mb-50">
                        ...
                        <div class="our-services-text">
                            <h3><a href="service-details.php">Wall Paintings</a></h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="our-services-wrapper text-center mb-50">
                        ...
                        <div class="our-services-text">
                            <h3><a href="service-details.php">pipe fitting</a></h3>
                            <p>Lorem ipsum dolor sit amet, consecte turlol adipi sicin loss elit, sed do eiusmod tempor incididunt ut labore et dolore</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="our-services-wrapper text-center mb-50">
                        ...
                        <div class="our-services-text">
                            <h3><a href="service-details.php">kitchen counter</a></h3>
                            <p>Lorem ipsum dolor sit amet, consecte turlol adipi sicin loss elit, sed do eiusmod tempor incididunt ut labore et dolore</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="our-services-wrapper text-center mb-50">
                        ...
                        <div class="our-services-text">
                            <h3><a href="service-details.php">furniture Moving</a></h3>
                            <p>Lorem ipsum dolor sit amet, consecte turlol adipi sicin loss elit, sed do eiusmod tempor incididunt ut labore et dolore</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="our-services-wrapper text-center mb-50">
                        ...
                        <div class="our-services-text">
                            <h3><a href="service-details.php">awire change</a></h3>
                            <p>Lorem ipsum dolor sit amet, consecte turlol adipi sicin loss elit, sed do eiusmod tempor incididunt ut labore et dolore</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="our-services-wrapper text-center mb-50">
                        ...
                        <div class="our-services-text">
                            <h3><a href="service-details.php">door replace</a></h3>
                            <p>Lorem ipsum dolor sit amet, consecte turlol adipi sicin loss elit, sed do eiusmod tempor incididunt ut labore et dolore</p>
                        </div>
                    </div>
                </div>
