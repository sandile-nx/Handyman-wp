<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from gambolthemes.net/html-items/Hmend_main_demo/instructor_dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Apr 2023 13:10:14 GMT -->
  <head>
    <meta charset="utf-8">
    ...
    <header class="header clearfix">
      ...
      <div class="header_right">
        <ul>
          ...
          <li>
            <a href="shopping_cart.html" class="option_links" title="cart">
            ...
            <div class="menu dropdown_ms">
              <a href="#" class="channel_my item">
                <div class="profile_link">
                  <img src="assets/img/images/left-imgs/img-6.jpg" alt>
              ...
              <a href="#" class="channel_my item">
                <div class="profile_link">
                  <img src="assets/img/images/left-imgs/img-5.jpg" alt>
                  <div class="pd_content">
                    <h6>Joy Dua</h6>
              ...
              <a href="#" class="channel_my item">
                <div class="profile_link">
                  <img src="assets/img/images/left-imgs/img-8.jpg" alt>
                  <div class="pd_content">
                    <h6>Jass</h6>
              ...
              <a class="vbm_btn" href="#">View All <i class="uil uil-arrow-right"></i>
              </a>
            </div>
          </li>
          <li class="ui dropdown">
            ...
            <div class="menu dropdown_mn">
              <a href="#" class="channel_my item">
                <div class="profile_link">
                  <img src="assets/img/images/left-imgs/img-1.jpg" alt>
                  <div class="pd_content">
                    <h6>Rock William</h6>
              ...
              <a href="#" class="channel_my item">
                <div class="profile_link">
                  <img src="assets/img/images/left-imgs/img-2.jpg" alt>
                  <div class="pd_content">
                    <h6>Jassica Smith</h6>
              ...
              <a href="#" class="channel_my item">
                <div class="profile_link">
                  <img src="assets/img/images/left-imgs/img-9.jpg" alt>
                  <div class="pd_content">
          ...
          <li class="ui dropdown">
            <a href="#" class="opts_account" title="Account">
              <img src="assets/img/images/hd_dp.jpg" alt>
            </a>
              ...
              <div class="channel_my">
                <div class="profile_link">
                  ...
                  <div class="pd_content">
                    ...
                    <span>
                      <a href="https://gambolthemes.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6205030f000d0e5b565122050f030b0e4c010d0f">[email&#160;protected]</a>
                    </span>
                  </div>
                </div>
                <a href="#" class="dp_link_12">View Instructor Profile</a>
              </div>
              <div class="night_mode_switch__btn">
                <a href="#" id="night-mode" class="btn-night-mode">
                  <i class="uil uil-moon"></i> Night mode <span class="btn-night-mode-switch">
                    <span class="uk-switch-button"></span>
                  </span>
                </a>
              </div>
              <a href="instructor_dashboard.php" class="item channel_item">Hmend dashboard</a>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
              <div class="card_dash">
                ...
                <div class="card_dash_right">
                  <img src="assets/img/images/dashboard/achievement.svg" alt>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6">
              <div class="card_dash">
                ...
                <div class="card_dash_right">
                  <img src="assets/img/images/dashboard/graduation-cap.svg" alt>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6">
              <div class="card_dash">
                ...
                <div class="card_dash_right">
                  <img src="assets/img/images/dashboard/online-course.svg" alt>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6">
              <div class="card_dash">
                ...
                <div class="card_dash_right">
                  <img src="assets/img/images/dashboard/knowledge.svg" alt>
                </div>
              </div>
            </div>
            <div class="col-md-12">
                ...
                <div class="la5lo1">
                  <div class="owl-carousel courses_performance owl-theme">
                    <div class="item">
                      <div class="fcrse_1">
                        <a href="#" class="fcrse_img">
                          <img src="assets/img/images/courses/img-1.jpg" alt>
                    ...
                    <div class="item">
                      <div class="fcrse_1">
                        <a href="#" class="fcrse_img">
                          <img src="assets/img/images/courses/img-2.jpg" alt>
                          <div class="course-overlay"></div>
                        </a>
                        <div class="fcrse_content">
                          <div class="vdtodt">
                    ...
                    <div class="item">
                      <div class="fcrse_1">
                        <a href="#" class="fcrse_img">
                          <img src="assets/img/images/courses/img-3.jpg" alt>
                          <div class="course-overlay"></div>
                        </a>
                        <div class="fcrse_content">
                          <div class="vdtodt">
                ...
                <div class="la5lo1">
                  <div class="owl-carousel edututs_news owl-theme">
                    <div class="item">
                      <div class="fcrse_1">
                        <a href="#" class="fcrse_img">
                          <img src="assets/img/images/courses/news-1.jpg" alt>
                        </a>
                        <div class="fcrse_content">
                    ...
                    <div class="item">
                      <div class="fcrse_1">
                        <a href="#" class="fcrse_img">
                          <img src="assets/img/images/courses/news-2.jpg" alt>
                        </a>
                        <div class="fcrse_content">
                    ...
                    <div class="item">
                      <div class="fcrse_1">
                        ...
                        <div class="fcrse_content">
                          ...
                          <p class="news_des45">Ut porttitor mi vel orci Hmend, nec elementum neque malesuada. Phasellus imperdiet quam gravida pharetra aliquet. Integer vel ligula eget nisl dignissim hendrerit.</p>
                          <div class="auth1lnkprce">
                            <a href="#" class="cr1fot50">Learn More</a>
                          </div>
                        </div>
                ...
                <div class="la5lo1">
                  <div class="fcrse_1">
                    <div class="fcrse_content">
                      ...
                      <div class="allvperf">
                        <div class="crse-perf-left">View</div>
                        <div class="crse-perf-right">17k <span class="analyics_pr">
                      ...
                      <div class="allvperf">
                        ...
                        <div class="crse-perf-right">1 <span class="analyics_pr">
                      ...
                      <div class="allvperf">
                        ...
                        <div class="crse-perf-right">50 <span class="analyics_pr">
                  ...
                  <div class="fcrse_1">
                    <div class="fcrse_content">
                      <div class="upcming_card">
                        <a href="#" class="crsedt145">The Complete JavaScript Course 2020: Build Real Projects! <span class="pndng_145">Pending</span>
                        </a>
                        <p class="submit-course">Submitted <span>1 days ago</span>
                        </p>
                      ...
                      <li>
                        <a href="index.html">
                          <div class="footer_logo">
                            <img src="assets/img/images/logo1.svg" alt>
                          </div>
                        </a>
                      </li>
                      <li>
                        <p>© 2020 <strong>Hmend</strong>. All Rights Reserved. </p>
                      </li>
                    </ul>
                  </div>
                  <div class="col-md-6">
  ...
  <!-- Mirrored from gambolthemes.net/html-items/Hmend_main_demo/instructor_dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Apr 2023 13:10:20 GMT -->
</html>